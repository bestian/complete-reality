...
export const articles: ArticleInfo[] = [
  ...
  },
  {
    ...
    category: '掛單文集',
    date: '2026.07.18',
    summary: '以愛、平等、自由與無懼為關係秩序的圓心，辨析秩序、控制與被控制的不對稱，以及憤怒、破壞與逃避造成的失序；守中致靜，安住自己，回歸秩序。',
  },
  {
    slug: '替孩子活、隨孩子活、陪孩子活',
    title: '替孩子活、隨孩子活、陪孩子活',
    author: '唐宗浩',
    category: '掛單文集',
    date: '2026.07.26',
    summary: '親子界限隨孩子成長而動態改變。嬰幼兒時父母須「替孩子活」，但若一味控制會扼殺自主；另一方面，若一味「隨孩子活」放任滿足，則讓孩子失去依靠。真正的「陪孩子活」是互為主體：既守住必要界限，也保留探索空間，依孩子的能力逐步把人生主導權還給他——在他需要時靠近，在他有能力時退後。衝突時兼顧感受與問題解決。',
  },
  {
    slug: '為什麼要吃蔬食為主',
    title: '為什麼要吃蔬食為主',
    ...
    category: '掛單文集',
    date: '2026.08.19',
    summary: '人活在世上，不一定需要靠犧牲其他生命來果腹。購買肉食雖非親手宰殺，仍是在間接支持產銷鏈上的殺生；畜牲有情，也會恐懼、疼痛、依戀。蔬食不是非黑即白的選擇，在全蔬與全葷之間有很寬廣的空間——從一週一天開始，少吃一餐肉、多認識一道蔬食料理，都是有意義的改變。吃蔬食為主不必是苦行，而是讓身體少一些負擔、內心多一些安穩，對動物好，也是對自己好。',
  },
]
