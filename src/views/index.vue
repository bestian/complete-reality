      ...
      <section class="article-section">
        ...
        <div class="ui relaxed items article-list">
          ...
          <div
            ...
            :class="{ 'is-guest-article': article.category === '掛單文集' }"
          >
            <div class="content">
              <a
                v-if="article.category === '掛單文集'"
                :href="withKeyword(`/category/${encodeURIComponent(article.category)}`)"
                class="guest-article-badge"
                data-list-state-link
              >掛單文</a>
